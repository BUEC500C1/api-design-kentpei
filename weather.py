...
def getinfo1(x,y):
    url = "http://api.openweathermap.org/data/2.5/weather?" + "lat=" + str(y) + "&lon=" + str(x) + "&APPID=98890b28aebc9ab089b941017e6a499a"
...
def getinfo2(city):
    url = "http://api.openweathermap.org/data/2.5/weather?" + "q=" + city + "&APPID=98890b28aebc9ab089b941017e6a499a"
    content = requests.get(url).content
    new = content.decode("utf-8")
    content_json = json.loads(new)
    #print(new)
